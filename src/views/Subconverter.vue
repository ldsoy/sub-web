  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://subconverter.annanangel.workers.dev/sub?" }],
        remoteConfig: [
        {
            label: "ACL4SSR",
            options: [
          ...
          },
          {
            ...
            options: [
              {
                label: "ACL4SSR_Mini 神器专用",
                value:
                  "https://ldsoy.coding.net/p/Config/d/Sub/git/raw/main/Config/Mini.ini?download=false"
              },
              {
                label: "Geoip_GFW 禁漫分流",
                value:
                  "https://ldsoy.coding.net/p/Config/d/Sub/git/raw/main/Config/ChinaIp_GFW.ini?download=false"
              }
            ]
          },
          {
